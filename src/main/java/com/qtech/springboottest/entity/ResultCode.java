...
// 参数错误
    ...
    //token错误
    public static final int PERMISSION_TOKEN_EXPIRED = 80001; //token过期
    public static final int PERMISSION_TOKEN_INVALID = 80002; //token解析异常
    public static final int PERMISSION_SIGNATURE_ERROR = 90001; //签名异常
}
